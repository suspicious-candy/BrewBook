 ...
 * generates a short-lived (5-minute) authorization code, stores it in Redis
 ...
 *   single-use refresh token stored in Redis, then deletes the authorization code.
 *
 ...
 *
 * Access tokens are issued with audience set to RESOURCE_SERVER_AUDIENCE so that
 * the resource server can validate the aud claim and reject tokens not intended for it.
 */
